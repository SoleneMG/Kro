...
public class Exercice18 implements Runnable{
    ...
    public void run() {
        ...
        System.out.println("Tu dois avoir "+folderGenerator.getLastGenerationFoldersCount()+" dossiers (incluant le parent) et "+folderGenerator.getLastGenerationFilesCount()+" fichiers, sinon tu peux krogonoler");
